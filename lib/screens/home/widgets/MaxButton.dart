...
import 'package:noroeste/screens/maxResult/MaxResult.dart';

import 'TextSpace.dart';
...
class MaxButton extends StatelessWidget {
  ...
  MaxButton(this.numFilas, this.numColumnas, this.cantidadElementos, this.textSpaceItemList);
  ...
  Widget build(BuildContext context) {
    return   CupertinoButton(
      ...
      onPressed: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => MaxResult(listaSolucion,numFilas, numColumnas, cantidadElementos,costoTotal)),
        );
      },
    );
  }
